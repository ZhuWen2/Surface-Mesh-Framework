...
void SurfaceMeshProcessing::createActions()
{
	...
	//点云滤波
	/*********** 新增按钮 **************/
	bilateralfilter = new QAction(tr("bilateralfilter"), this);
	bilateralfilter->setIcon(QIcon("D:/XTOP/XTOPwork/mesh/meshview/Surface-Mesh-Framework-main/src/Images/connectFace.png"));
	bilateralfilter->setStatusTip(tr("bilateralfilter"));
	bilateralfilter->setCheckable(true);
	bilateralfilter->setChecked(false);
	connect(bilateralfilter, SIGNAL(triggered()), this, SLOT(bilateral()));

	/*********** 新增按钮 **************/
	pointCon = new QAction(tr("CloudFusion"), this);
	pointCon->setIcon(QIcon("D:/XTOP/XTOPwork/mesh/meshview/Surface-Mesh-Framework-main/src/Images/pointCon.png"));
	pointCon->setStatusTip(tr("CloudFusion"));
	pointCon->setCheckable(true);
	pointCon->setChecked(false);
	connect(pointCon, SIGNAL(triggered()), this, SLOT(CloudFusion()));


	/*********** 新增按钮 **************/
	TriangulationCloud = new QAction(tr("Triangulation"), this);
	TriangulationCloud->setIcon(QIcon("D:/XTOP/XTOPwork/mesh/meshview/Surface-Mesh-Framework-main/src/Images/bool.png"));
	TriangulationCloud->setStatusTip(tr("Triangulation"));
	TriangulationCloud->setCheckable(true);
	TriangulationCloud->setChecked(false);
	connect(TriangulationCloud, SIGNAL(triggered()), this, SLOT(Triangulation()));
...
void SurfaceMeshProcessing::createMenus()
{
	...
	/*********** 新增按钮 **************/
	viewMenu->addAction(bilateralfilter);
...
void SurfaceMeshProcessing::createToolBars()
{
	...
	/*********** 新增按钮 **************/
	mouseToolBar->addAction(bilateralfilter);
	mouseToolBar->addAction(pointCon);
	mouseToolBar->addAction(TriangulationCloud);
...
void SurfaceMeshProcessing::setAllMouseActionChecked(bool b)
{
	...
	bilateralfilter->setCheckable(b);
}
...
void SurfaceMeshProcessing::bilateral()
{
	setAllViewActionChecked(false);
	setAllMouseActionChecked(false);
	bilateralfilter->setChecked(true);
	viewer->setMouseMode(InteractiveViewerWidget::POINT_FILTER);

}

/******* 新增 **********/

void SurfaceMeshProcessing::CloudFusion()
{
	setAllViewActionChecked(false);
	setAllMouseActionChecked(false);
	bilateralfilter->setChecked(true);
	viewer->setMouseMode(InteractiveViewerWidget::REG_FUS);

}

/******* 新增 **********/

void SurfaceMeshProcessing::Triangulation()
{
	setAllViewActionChecked(false);
	setAllMouseActionChecked(false);
	TriangulationCloud->setChecked(true);
	viewer->setMouseMode(InteractiveViewerWidget::TRI);
